...
int main ( void ) 
{
	...
	char i;
	flag = 0;
	// advertising packet test, with fake address and crc.
	unsigned char rxPacket1[16] = { 0xAA, 0x8e, 0x89,
		0xbe, 0xd6, 0x00, 0x18, 0x00,0x00,0x00,0xff,0xff,0xff,0x00,0x01,0x11
		};
	// connection request packet test, with fake address/crc and no hop.
	unsigned char rxPacket2[53] = { 0xAA, 0x8e, 0x89,
		0xbe, 0xd6, 0x50,0x88,0x00,0x00,0x00,0x00,0x00,0xff,0x00,0x00,0x00,0xff,0xff,0xff,0xaa,0xbb,0x99,0x77,0x55,0x55,
		0x55,0x18,0x00,0x18,0x00,0x30,0x00,0x07,0x00,0x30,0x00,0x30,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0f,0xff
	};
	// Compose message
	sprintf ( send_packet , rxPacket1);
